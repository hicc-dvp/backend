...
class RestaurantRepositoryTest {
	...
	void findBySearchQuery() {
		// given
		Restaurant rest = new Restaurant("홍대 제육맛집", "한식", "서울 어딘가", 37.1234, 126.5678);
	...
	void uniqueConstraint() {
		// given
		Restaurant rest1 = new Restaurant("홍대 제육1", "한식", "서울 어딘가", 37.1, 126.5);
		rest1.setSearchQuery("홍대 한식 제육");
		restaurantRepository.save(rest1);

		Restaurant rest2 = new Restaurant("홍대 제육2", "한식", "서울 어딘가2", 37.2, 126.6);
